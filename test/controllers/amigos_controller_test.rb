...
class AmigosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create amigo" do
    assert_difference('Amigo.count') do
      post amigos_url, params: { amigo: { apellido: @amigo.apellido, email: @amigo.email, nombre: @amigo.nombre, telefono: @amigo.telefono, twitter: @amigo.twitter } }
    end
  ...
  test "should update amigo" do
    patch amigo_url(@amigo), params: { amigo: { apellido: @amigo.apellido, email: @amigo.email, nombre: @amigo.nombre, telefono: @amigo.telefono, twitter: @amigo.twitter } }
